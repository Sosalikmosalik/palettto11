export class PreloadScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('boss-village', 'assets/sprites/characters/boss-village.svg');
    ...
    this.load.image('stickman-red', 'assets/sprites/characters/stickman-red.svg');
    ...
    // Extended islands backgrounds
    this.load.image('bg-dungeon', 'assets/backgrounds/bg-dungeon.svg');
    this.load.image('bg-museum', 'assets/backgrounds/bg-museum.svg');
    this.load.image('bg-lab', 'assets/backgrounds/bg-lab.svg');
    this.load.image('bg-hell', 'assets/backgrounds/bg-hell.svg');
    this.load.image('bg-space', 'assets/backgrounds/bg-space.svg');
    ...
    // Extended islands icons
    this.load.image('icon-dungeon', 'assets/icons/icon-dungeon.svg');
    this.load.image('icon-museum', 'assets/icons/icon-museum.svg');
    this.load.image('icon-lab', 'assets/icons/icon-lab.svg');
    this.load.image('icon-hell', 'assets/icons/icon-hell.svg');
    this.load.image('icon-space', 'assets/icons/icon-space.svg');
    // Donation UI assets
    ...
    // UI extras
    this.load.image('icon-sword-yellow', 'assets/icons/icon-sword-yellow.svg');
    this.load.image('void-hole', 'assets/ui/void-hole.svg');
  }
  create() {
